...
#
#[ 8.10165e-05 -4.38739280e+00]
DATA_OPEN=$(echo "${DATA_RAW} " | grep ${OPENLOOPPV} | awk -v CONVFMT=%.17g -v scale=8.260944171779145e-05 -v offset=-4.5504240561928455 '{$NF*=scale;$NF+=offset; print $0}')
